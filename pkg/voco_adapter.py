...
class VocoAdapter(Adapter):
    ...
    def __init__(self, verbose=True):
        ...
        self.llm_data_dir_path = os.path.join(self.data_dir_path,'llm') # not sure
        ...
        for option in self.audio_controls:
            try:
                ...
                if str(option['human_device_name']) == str(self.persistent_data['audio_output']):
                    ...
                    if str(option['control_name']) != 'None' and str(option['control_name']) != "":
            ...
            if 'System audio volume' in config:
                ...
                if config['System audio volume'] != None:
                    ...
                    if volume_percentage == 0: # not even possible anymore as the minimum is now set to 10 in manifest.json
                        if self.DEBUG:
                            print("Warning: volume level was set to 0. It will be changed to 80 instead.")
...
#
    ...
    def scan_alsa(self,device_type):
        ...
        #if self.DEBUG:
        #    print("self.capture_card_id: ", self.capture_card_id)
    ...
    def set_speaker_volume(self, volume):
        ...
        try:
            ...
            if self.DEBUG:
                print("error setting volume property on thing: " + str(ex))
    ...
    def speak(self, voice_message="",intent='default'):
        ...
        try:
            ...
            self.last_sound_activity = time.time() - 1
            if self.DEBUG:
                print("Speak: sideId: " + str(site_id))
                if self.persistent_data['site_id'] == str(site_id):
                    print("- this is my own sideId")
                else:
                    print("this is not my siteId")
    ...
    def mute(self):
        ...
        if self.current_control_name != None and str(self.current_control_name) != "" and str(self.persistent_data['audio_output']) != 'Bluetooth speaker':
...
#
    ...
    def run_snips(self):
        ...
        try:
            ...
            local_mqtt_ip = "127.0.0.1:" + str(self.mqtt_port) # TODO: "localhost" is hardcoded here    
            if self.DEBUG:
...
#
    ...
    def run_mqtt(self):
        ...
        elif self.persistent_data['is_satellite'] == False and (str(self.persistent_data['mqtt_server']) != 'localhost' and str(self.persistent_data['mqtt_server']) != '127.0.0.1'):
            if self.DEBUG:
