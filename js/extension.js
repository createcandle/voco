	          ...
	          `/extensions/${this.id}/api/poll`
				...
				if(body['state'] == true){
					...
					if(this.items_list.length > 0 ){
						...
						list.innerHTML = '<div class="extension-voco-centered-page"><span>There are currently no timers, reminders, alarms or a countdown set.</span></div>';
					}
			          ...
			          `/extensions/${this.id}/api/poll`
						...
						if(body['state'] == true){
							...
							if(this.items_list.length > 0 ){
								...
								list.innerHTML = '<div class="extension-voco-centered-page"><span>There are currently no timers, reminders or alarms set.</span></div>';
							}
				...
				for( var item in items ){
					...
					if( type == 'value' || type == 'actuator' ){
						try{
							...
							console.log("error handling change data: " + e);
						}
