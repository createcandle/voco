...
wget --retry-connrefused --waitretry=1 --read-timeout=20 --timeout=15 -t 3 https://media.projektzentrisch.de/temp/signal-cli/libsignal_jni_so0941_ubuntu2004_arm64.gz -O libsignal_jni_so0921_ubuntu2004_arm64.gz
